...
@NonExtendable()
@NonBlocking()
public final class InaccessibleLatentException extends LatentException implements Serializable {

	@AvailableSince(value = "0.1-build.1")
	@NonBlocking()
	@Contract(pure = true)
	public InaccessibleLatentException(@Nullable(value = "Can be null anytime") final String message, @Nullable(value = "Can be null anytime") final Throwable cause) throws Error {
	...
	@NonBlocking()
	@Contract(pure = true)
	public InaccessibleLatentException(@Nullable(value = "Can be null anytime") final Throwable cause) throws Error {
	...
	@NonBlocking()
	@Contract(pure = true)
	public InaccessibleLatentException(@Nullable(value = "Can be null anytime") final String message) throws Error {
	...
	@Override()
	public synchronized @NotNull(exception = NullPointerException.class) InaccessibleLatentException initCause(final @Nullable(value = "Can be null anytime") Throwable cause) throws Error {
	...
	@Contract(value = " -> this")
	@Override()
	public synchronized @NotNull(exception = NullPointerException.class) InaccessibleLatentException fillInStackTrace() throws Error {
