...
@NonExtendable()
@NonBlocking()
public final class LatentTargetException extends LatentException implements Serializable {

	@AvailableSince(value = "0.1-build.1")
	@NonBlocking()
	@Contract(pure = true)
	public LatentTargetException(@Nullable(value = "Can be null anytime") final String message, @Nullable(value = "Can be null anytime") final Throwable cause) throws Error {
	...
	@NonBlocking()
	@Contract(pure = true)
	public LatentTargetException(@Nullable(value = "Can be null anytime") final Throwable cause) throws Error {
	...
	@NonBlocking()
	@Contract(pure = true)
	public LatentTargetException(@Nullable(value = "Can be null anytime") final String message) throws Error {
	...
	@Override()
	public synchronized @NotNull(exception = NullPointerException.class) LatentTargetException initCause(final @Nullable(value = "Can be null anytime") Throwable cause) throws Error {
	...
	@Contract(value = " -> this")
	@Override()
	public synchronized @NotNull(exception = NullPointerException.class) LatentTargetException fillInStackTrace() throws Error {
